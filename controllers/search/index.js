...
module.exports = function(router){
	...
	router.get('/image/:city/:state', apicache("1 second"),function(request,response,next){
	...
	router.get('/news/:city/:state', apicache("1 second"),function(request,response,next){
		var city = request.params.city;
		var state = request.params.state;
